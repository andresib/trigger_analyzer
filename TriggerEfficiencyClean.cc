...
class TriggerEfficiencyClean : public edm::EDAnalyzer {

public:
   explicit TriggerEfficiencyClean(const edm::ParameterSet&);
   ~TriggerEfficiencyClean();
...
TriggerEfficiencyClean::TriggerEfficiencyClean(const edm::ParameterSet& iConfig):
...
TriggerEfficiencyClean::~TriggerEfficiencyClean(){
}

void
TriggerEfficiencyClean::analyze(const edm::Event& iEvent, 
...
if (cortetau>0 &&  mjj40 > 750  &&  passtrig0>0 ) {
...
if (cortetau>0 &&  mjj40 > 750  &&  passtrig1>0 ) {
...
if (cortetau>0 &&  mjj40 > 750  &&  passtrig2>0 ) {
...
void 
TriggerEfficiencyClean::beginJob()
{
...
void 
TriggerEfficiencyClean::endJob() 
{
}

#include "FWCore/Framework/interface/MakerMacros.h"
DEFINE_FWK_MODULE(TriggerEfficiencyClean);
