...
void histo4(std::string outfilename) {
...
directory->GetObject("metPt_case1", histo1);
directory->GetObject("metPt_case1_trigger0",histo2);
directory->GetObject("metPt_case1_trigger1",histo3);
directory->GetObject("metPt_case1_trigger2",histo4);
...
histo3->Rebin(4);
histo4->Rebin(4);
histo1->SetName("Cuts 1a");
histo2->SetName("Trigger 1 + Cuts 1a");
histo3->SetName("Trigger 2 + Cuts 1a");
histo4->SetName("Trigger 3 + Cuts 1a");
//NUM->Rebin(4);
//DEN->Draw();
...
/*
  TPaveText *pt4 = new TPaveText(0.0681363   ,0.872464    ,0.691383  ,0.988406  ,"blNDC");
    ...
    */
        ...
        legend->AddEntry(histo1, "Cuts 1a","f");
        legend->AddEntry(histo2, "Trigger 1 + Cuts 1a","f");
        legend->AddEntry(histo3, "Trigger 2 + Cuts 1a","f");
        legend->AddEntry(histo4, "Trigger 3 + Cuts 1a","f");
        legend->Draw();
